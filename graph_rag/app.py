...
def load_model():
    ...
    groq_llms = ['llama3-8b-8192', "llama3-groq-8b-8192-tool-use-preview", 'mixtral-8x7b-32768', 'gemma2-9b-it']
    groq_llms = [llm_groq] + [ChatGroq(temperature=0, model_name=i, api_key='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') for i in groq_llms]
    # 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
    ...
    return groq_llms, graph, reranker, huggingface_embeddings,  vector_index


groq_llms, graph, reranker, huggingface_embeddings,  vector_index = load_model()
...
def get_response(question: str) -> str:
    ...
    """
    rag = GraphRAG(llm = llm, embedding_model=huggingface_embeddings, reranker=reranker, llms = groq_llms, vector_index=vector_index)
